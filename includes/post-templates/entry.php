			...
			<?php if( !is_single() ) { ?>
				...
				<div class="post-meta <?php echo $extra_class; ?>">
					...
					<?php if(($masonry_type == 'classic_enhanced' && $using_masonry == true)) { ?>
						<span class="meta-author"> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"> <i class="icon-default-style icon-salient-m-user"></i> <?php the_author(); ?></a> </span><a href="<?php comments_link(); ?>">
					...
					<div class="author">
						<?php if(!($masonry_type == 'classic_enhanced' && $using_masonry == true)) { ?>
							<span class="meta-author"><?php the_author_posts_link(); ?></span></div><!--/author--><a href="<?php comments_link(); ?>"><div class="comments"><span class="meta-comment-count">
							<?php comments_number( __('0', NECTAR_THEME_NAME), __('1', NECTAR_THEME_NAME), __('%', NECTAR_THEME_NAME) ); ?></a></span>
						<?php } ?>
					</div> <!--/comments-->
				</div><!--/post-meta-->
